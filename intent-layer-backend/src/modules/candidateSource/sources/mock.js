...
const MOCK_PROFILES = [
  {
    id: "mock-1",
    name: "Trattoria Roma",
    description: "Authentic Italian cuisine in SoHo. Family-run restaurant serving pasta, pizza, and regional dishes.",
    ...
    facilities: [{ id: "f1", name: "Wi-Fi" }, { id: "f2", name: "Outdoor seating" }, { id: "f3", name: "Wheelchair accessible" }],
  },
  {
    id: "mock-2",
    name: "Bella Cucina",
    description: "Upscale Italian dining in Midtown. Modern twist on classic recipes.",
    address: "456 5th Ave, Manhattan, NY",
    lat: 40.753,
    lng: -73.981,
    averageRating: 4.5,
    totalReviews: 210,
    services: [{ id: "s2a", name: "Lunch", minSpend: 35, category: "Dining" }, { id: "s2b", name: "Dinner", minSpend: 55, category: "Dining" }],
    facilities: [{ id: "f4", name: "Private dining" }, { id: "f5", name: "Full bar" }],
  },
  {
    id: "mock-3",
    name: "Cafe Italiano",
    ...
    facilities: [{ id: "f6", name: "Wi-Fi" }, { id: "f7", name: "Outdoor seating" }],
  },
];
