...
const Offer: React.FC<T_OFFER_SCREEN> = ({ navigation }) => {
  ...
  const availabilityData = [
    { id: "1", time: "26/12/2024 23:00", duration: "02 Hour", selected: false },
    { id: "2", time: "26/12/2024 23:00", duration: "02 Hour", selected: false },
  ];

  const renderAvailabilityItem = ({ item }: any) => (
    <TouchableOpacity
          ...
          <View style={styles.mainContainer}>
            ...
            <View style={styles.noteSection}>
              ...
              <Text style={styles.noteText}>
                We are not available at the gym time you selected. Please choose
                an available time from the options below.
              </Text>
            </View>
